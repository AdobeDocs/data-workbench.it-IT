...
<table id="table_99EA23BBC1A148B49643F4B5E4341C08">
 ...
 <tbody>
  <tr>
   <td colname="col1"> <p>Server Apache / IBM HTTP Server 2.2 </p> </td>
   <td colname="col2"> <p>Microsoft Windows Server 2003 o versione successiva; RedHat Enterprise Linux 6.x o successivo; Sun Solaris 8.x o successivo; IBM AIX 5.1x o successivo. </p> </td>
  </tr>
  <tr>
