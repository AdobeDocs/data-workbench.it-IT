---
description: Istruzioni dettagliate per l'installazione e la configurazione di Sensor per WebLogic Server 6.x o versione successiva in esecuzione in Microsoft Windows Server 2000 o versione successiva.
title: Server WebLogic su Windows Server 2000 o versione successiva
...
# Server WebLogic su Windows Server 2000 o versione successiva{#weblogic-server-on-windows-server-or-later}

{{eol}}

Istruzioni dettagliate per l&#39;installazione e la configurazione di Sensor per WebLogic Server 6.x o versione successiva in esecuzione in Microsoft Windows Server 2000 o versione successiva.
...
1. Sul server WebLogic, crea una directory in cui installare i file del programma Sensor. Tenere presente che la coda del disco si trova in questa directory, quindi assicurarsi che il dispositivo scelto abbia spazio sufficiente per contenere una coda delle dimensioni necessarie.
...
<table id="table_ABFF5F92271B4F3CB0AC68DAB6A5709F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> Le librerie dei moduli di caricamento del raccoglitore </td> 
...
Istruzioni per la modifica dello script di avvio.

Nello script utilizzato per avviare WebLogic (ad esempio, C:\bea\user_projects\mydomain\startServer.cmd), modifica la riga &quot;set JAVA_OPTIONS=&quot; per impostare la definizione java.library.path alla directory contenente il file visual_sciences.dll.
