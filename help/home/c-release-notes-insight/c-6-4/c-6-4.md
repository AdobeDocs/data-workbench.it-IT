---
description: Le note sulla versione di Data Workbench 6.4 includono nuove funzioni, requisiti per l'aggiornamento, bug corretti e problemi noti.
...
Le note sulla versione di Data Workbench 6.4 includono nuove funzioni, requisiti per l&#39;aggiornamento, bug corretti e problemi noti.

Per visualizzare le funzioni e le correzioni precedenti per le versioni precedenti, consulta l’archivio [delle note sulla](https://docs.adobe.com/content/help/it-IT/data-workbench/using/release-notes/release-notes.html)versione.

## Nuove funzionalità {#section-e844b52c18484e99bdda5c361402247d}

La versione di Data Workbench 6.4 include le seguenti nuove funzioni:

| Funzioni di DWB 6.4 | Descrizione |
|--- |--- |
| [Esportazione nei servizi core di Analytics](/help/home/c-release-notes-insight/c-6-4/dwb-crs-integration.md) | La funzione di esportazione CRS (Customer Record Service) consente di esportare i dati delle Date Workbench dalla tabella Dettagli ai servizi core Adobe Analytics  per l&#39;integrazione con altre funzionalità di Analytics, tra cui Reporting e analisi. |
...
| [Blocco dei profili nella workstation](/help/home/c-get-started/c-admin-intrf/c-prof-mgr/dwb-profile-lock.md) | Potete impedire che i profili vengano sovrascritti dagli utenti che lavorano nei gestori di profili, Dimension, rapporti, aree di lavoro, metriche o filtri. In Gestione profili, salva il file Internal.cfg in un profilo personalizzato per evitare che più file di profilo nel sistema vengano sovrascritti sul server. |
| [Nuove funzioni dell&#39;interfaccia utente](/help/home/c-adobe-data-workbench-dashboard/t-getting-started/c-dashboard-user-interface.md) | La versione di Data Workbench 6.4 aggiunge all’Aiuto nuove icone dell’area di lavoro, descrizioni comandi, schermate iniziali e un collegamento F1. Consente inoltre di aprire i file di registro selezionando Aiuto > Open Trace Directory (Apri directory di traccia) dalla barra degli strumenti. |
...
A partire dalla versione di Data Workbench 6.4, potete ignorare il limite di elementi nella cache predefinito pari a &quot;100000&quot; modificandone il valore e salvando il file. Il valore predefinito è stato selezionato per essere sufficiente per la maggior parte delle esigenze.
...
Per effettuare l’aggiornamento alla Data Workbench 6.4, attenetevi a questi requisiti e consigli.
...
* **Aggiornate le impostazioni *Attribution-Premium***. Se disponete di profili personalizzati con impostazioni di parametro che ignorano il profilo SC *predefinito* Adobe, dovete aggiornare i campi personalizzati nei seguenti file di configurazione:
...
* **Aggiornate la versione di Microsoft Excel** (se necessario).
   ...
   Con la release di Data Workbench 6.4, il supporto per Excel 2007 è stato interrotto. Inoltre, poiché l&#39;Data Workbench viene eseguita solo in Microsoft Windows per l&#39;architettura a 64 bit, si consiglia di installare anche una versione a 64 bit di Microsoft Excel.
...
Di seguito sono riportate le restrizioni note nella Data Workbench 6.4.

* **`ExportIntegration.exe`**   richiede argomenti di riga di comando in inglese. The output file name should be named in English for *Adobe Target Export*, *Profiles and Audiences Export*, and *Customer Record Service Export*.
