---
description: Le note sulla versione di Workbench dati 6.3 includono nuove funzioni, requisiti di aggiornamento, bug corretti e problemi noti.
title: Note sulla versione di Workbench dati 6.3
...
Le note sulla versione di Workbench dati 6.3 includono nuove funzioni, requisiti di aggiornamento, bug corretti e problemi noti.

## Nuove funzionalità {#section-1225066ea8f44cf68e42e019d0bca816}

Workbench dati 6.3 include le seguenti nuove funzioni:
...
<table id="table_E28A6D31E7D941F7A0C2048F0F0F7838"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> Condividi in Adobe Experience Cloud segmenti di clienti avanzati creati in Workbench dati. Integrating with Profiles and Audiences enables the <a href="https://www.adobe.com/solutions/digital-marketing.html?promoid=KLXLZ" format="https" scope="external"> Adobe Experience Cloud </a> and other Adobe Analytic capabilities the opportunity to leverage rich audience segments created in Data Workbench. Questo richiede che Experience Cloud sia configurato e in esecuzione. <p>L'integrazione con Master Experience Cloud consente di eseguire funzioni predittive come il clustering o il punteggio di propensione, quindi di inviare i segmenti a Adobe Experience Cloud di dimensioni maggiori o ad altri prodotti quali Adobe Target e Adobe Experience Manager. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> Le nuove scelte rapide da tastiera in Workbench dati consentono di spostarsi tra il piano di lavoro principale e le singole aree di lavoro utilizzando i tasti freccia. Inoltre, la barra degli strumenti nell'area di lavoro adesso è visualizzata sulla finestra del piano di lavoro. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Supporto di Windows 8.1 </td> 
   <td colname="col2"> Microsoft Windows 8.1 a 64 bit è <a href="https://docs.adobe.com/content/help/en/data-workbench/using/install/c-data-workbench-client-install.html" format="https" scope="external"> ora supportato </a> per l'installazione client. </td> 
  </tr> 
 </tbody> 
</table>
...
* **Adobe Target con aggiornamento** dell&#39;integrazione DWB. Un nuovo file di esportazione [!DNL ExportIntegration.exe]sostituisce il [!DNL TnTSend.exe] file esistente in Insight Server ( [!DNL E:\Server\Scripts\TnTSend.exe]). Questo nuovo file di esportazione supporta sia l&#39;integrazione di Adobe Target che il coordinamento con il nuovo profilo di marketing principale (MMP) e Adobe Audience Manager.
...
* **Aggiornate il client dal server**.
   ...
   1. Collegarsi al profilo.
      ...
      Il client eseguirà automaticamente l&#39;aggiornamento a Workbench dati 6.3.
...
* **Raccomandazione**: **Nuovi temi Windows Aero. ** Aggiornare l&#39;aspetto dell&#39;applicazione client utilizzando i temi di Windows Aero.
...
Per eseguire l&#39;attribuzione **** Adattaottimale in Workbench dati, è necessario ricevere nuovi certificati da Adobe ClientCare per Client, Server e Report Server (file .pem) per supportare Adobe Analytics Premium. Ogni nuovo certificato avrà il seguente parametro:
...
* **L&#39;aggiunta di dimensioni** mostra solo le *dimensioni* estese. La soluzione consiste nell&#39;utilizzare lo strumento **Finder** per trascinare le dimensioni nelle tabelle.
