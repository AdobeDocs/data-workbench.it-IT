---
description: Una guida rapida per diversi metodi di trasferimento file in DWB.
...
Una guida rapida per diversi metodi di trasferimento file in DWB.

La gestione dei trasferimenti di file è un processo standard per trasferire i file da una directory interna a qualsiasi altro server o movimento interno di file.

## Diversi metodi di trasferimento file {#section-972bb39ba1954c6ebd35f6d042593efe}

1. AWS (Amazon Web Services)

   1. Alzate un biglietto per installare l&#39;interfaccia della riga di comando AWS sul server, se non è già installata (consultate [http://docs.aws.amazon.com/cli/latest/userguide/installing.html](http://docs.aws.amazon.com/cli/latest/userguide/installing.html)).
   1. Come controllare? Provate a configurare il prompt dei comandi AWS (consultate [http://docs.aws.amazon.com/cli/latest/userguide/cli-chap-getting-started.html](http://docs.aws.amazon.com/cli/latest/userguide/cli-chap-getting-started.html)).

1. Trasferire i file dal server FTP alla directory NAS.

   1. Feed offline FTP dal server ftp alla directory NAS. I dettagli riportati di seguito sono richiesti per l&#39;FTP.
      ...
      (i dettagli FTP saranno disponibili nell&#39;elenco di controllo del progetto. Usa utente ftp esterno per trasferire i file)

   1. Utilizzate lo script ftp_winscp_get.pl allegato di seguito e pianificate in base ai requisiti.
      ...
      >[!NOTE]
      >
      >Se la cartella Scripting non è disponibile, consultate Rielaborazione [settimanale](../../../home/dwb-implement-overview/dwb-implement-configure/dwb-implement-reprocess-scripting.md#concept-60529e12d6d94386a02c1c6fdedf0295) per scaricare la cartella.

   1. Pianificare lo script in base alla disponibilità dei file all&#39;indirizzo ftp_address.
   1. La convenzione di denominazione del file deve essere YYYYYMMDD-&lt;nome_feed_offline>-00.*

1. Trasferire i file dalla directory NAS al server FTP.

   1. Utilizzate lo script ftp_winscp_put.pl e pianificate in base ai requisiti.
...
1. Trasferisci i file da una directory NAS ad un&#39;altra directory NAS.
   ...
   1. Copiare e incollare i file direttamente collegati a una directory NAS da un&#39;altra. Seguire la procedura riportata di seguito:)

      accedere al server -> andare a Run -> \\server_name\E$ [nuova cartella si aprirà e copierà o sposterà direttamente i file]

   1. Utilizzare lo script &quot;copy_files.pl&quot; per copiare i file da un server all&#39;altro o &quot;move_files.pl&quot; per spostare i file da un server all&#39;altro. (Questi file sono disponibili in E:\scripts\Scripository)
