...
## Creare un filtro {#section-70ba51ae625e493fa3ca70b93ffba406}

* Apri un editor di filtri nell’area di lavoro facendo clic con il pulsante destro del mouse **[!UICONTROL Add Visualization]** > **[!UICONTROL Filter Editor]**.
...
## Aggiungere una condizione a un nuovo filtro {#section-50986db80f1148c489630a8a63fe9f28}
...
1. Fare clic con il pulsante destro del mouse nell’area contrassegnata **[!UICONTROL Right-click to build filter]** e selezionare una delle seguenti opzioni:
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Definisce una condizione di filtro basata sul valore di una metrica specificato. </p> <p>Per definire la condizione, effettua le seguenti operazioni: 
     <ul id="ul_B69D31258A36460E94535709239CD165"> 
      <li id="li_51317A681E654DD7A9D997DF9F2F22BA">Fai clic con il pulsante destro del mouse <span class="uicontrol"> [scegli livello]</span> &gt; <span class="uicontrol"> Cambia livello</span> per selezionare il livello e la metrica da un elenco di dimensioni nel set di dati. </li> 
      <li id="li_975E56C335824FDCB988344952DE2E9F">Fai clic con il pulsante destro del mouse <span class="uicontrol"> [scegli metrica]</span> &gt; <span class="uicontrol"> Cambiare metrica</span> per selezionare la metrica da un elenco di metriche nel set di dati. </li> 
      <li id="li_D00B3AF3D8DE472C9D0E9EABBBCAAF61">Fai clic con il pulsante destro del mouse meno di e fai clic su <span class="uicontrol"> Modifica confronto</span> per selezionare una delle condizioni di confronto disponibili (minore di, più di, esattamente, almeno o al massimo). </li> 
      <li id="li_3334CE0A0950448590E5442AB243F46B">Digita il valore desiderato per la metrica. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>first/last </p> </td> 
   <td colname="col2"> <p>Definisce un filtro che consente di includere o escludere un livello con una dimensione specificata. Ad esempio, puoi specificare un primo/ultimo filtro da includere (o escludere): </p> <p>Sessioni la cui ultima visualizzazione di pagina include una pagina di <span class="filepath"> /hme/rts/Nostre tariffe</span>. </p> <p>Per definire una condizione Primo/Ultimo: 
     <ul id="ul_5AD916DA093844B8AC70127B1EB9BFC8"> 
      <li id="li_AB9FF22ADC8843A79856FED60B9478FA">Scegli <span class="uicontrol"> Includi gruppo con</span> o <span class="uicontrol"> Escludi gruppo con</span> &gt; <span class="uicontrol"> first/last</span> come nuova condizione nell’Editor filtri. </li> 
      <li id="li_92F536FCC2A74DDE97F66C6C45ACC3DC">Fai clic con il pulsante destro del mouse <span class="uicontrol"> [scegli contenitore]</span> &gt; <span class="uicontrol"> Cambia contenitore</span> per selezionare il contenitore . </li> 
      <li id="li_1E5DBE04ABC74D84B7C0EF6886CDB5DC">Clic destro <span class="uicontrol"> first</span> o <span class="uicontrol"> last</span> per specificare il livello. </li> 
...
* Fai clic sul pulsante **x** a sinistra della condizione per eliminarla.
...
* Fai clic con il pulsante destro del mouse sulla condizione e fai clic su **[!UICONTROL Edit description]**.
   ...
   * Per aggiungere o modificare una descrizione, digita la descrizione nel campo [!DNL Edit condition description] campo . La descrizione viene visualizzata tra virgolette sopra la condizione nella finestra dell’editor filtri.
