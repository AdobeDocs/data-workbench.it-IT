...
+ Note sulla versione {#release-notes}
   + [Panoramica delle note sulla versione](c-release-notes-insight/release-notes.md)
...
+ Installazione {#install}
   ...
   + Configurazione della workstation {#workstation-setup}
      + [Panoramica della configurazione della workstation](c-install-insight/install-setup/install-setup.md)
   ...
   + Aggiornamento di Data Workbench {#upgrade-dwb}
      + [Panoramica dell’aggiornamento di Data Workbench](c-install-insight/c-upgrd-ins/c-upgrd-ins.md)
      + [Aggiornamento da 6.4 a 6.5](c-install-insight/c-upgrd-ins/c-6-4-to-6-5-upgrade.md)
      + [Aggiornamento da 6.3 a 6.4](c-install-insight/c-upgrd-ins/c-6-3-to-6-4-upgrade.md)
      + [Aggiornamento del server DWB: da 6.1 a 6.2](c-inst-svr/c-upgrd-uninst-sftwr/c-upgrd-sftwr/c-6-1-to-6-2-upgrade.md)
      + [Aggiornamento Data Workbench da 6.0 a 6.1](c-inst-svr/c-upgrd-uninst-sftwr/c-upgrd-sftwr/c-6-0-to-6-1-upgrade/c-6-0-to-6-1-upgrade.md)
      + [Aggiornamento Data Workbench da 5.5 a 6.1](c-inst-svr/c-upgrd-uninst-sftwr/c-upgrd-sftwr/c-5-x-to-6-1-upgrade.md)
+ Client {#client}
   ...
   + [Controllo delle versioni dei file](c-get-started/c-unstd-file-ver.md)
   + [Utilizzo del menu delle miniature del Worktop](c-get-started/c-wktp-thumb-menu.md)
   + [Configurare la barra laterale](c-get-started/c-config-sidebar.md)
   + Visualizzare le aree di lavoro {#display-workspaces}
      ...
      + [Menu File dell’area di lavoro](c-get-started/c-work-worksp/c-use-wksp-file-menu.md)
      + [Adattare un’area di lavoro](c-get-started/c-work-worksp/c-refit-wksp.md)
      + [Condividere un’area di lavoro](c-get-started/c-work-worksp/c-share-wksp.md)
   ...
   + Utilizzo delle finestre in un’area di lavoro {#working-with-windows-workspace}
      + [Panoramica dell&#39;utilizzo delle finestre in un’area di lavoro](c-get-started/c-wk-win-wksp/c-wk-win-wksp.md)
      + [Modificare le finestre in un’area di lavoro](c-get-started/c-wk-win-wksp/c-man-win-wksp.md)
      + [Utilizzare il testo nelle finestre](c-get-started/c-wk-win-wksp/c-work-text-win.md)
   ...
   + Esportazione dei dati {#export-data}
      ...
      + [Esportazione guidata del segmento](c-get-started/c-exp-data-seg-exp/segment-export.md)
   ...
   + Rapporti di attribuzione {#attribution-reports}
      ...
      + [Attribuzione per adattamento ottimale](c-get-started/c-attribution-profiles/c-attrib-algorithmic/c-attrib-algorithmic.md)
      + [Creare un modello di attribuzione per adattamento ottimale](c-get-started/c-attribution-profiles/c-attrib-algorithmic/c-attrib-building.md)
   + Visualizzazioni {#visualizations}
      ...
      + Effettuare le selezioni {#make-selections}
         ...
         + [Ingrandire per visualizzare le visualizzazioni](c-get-started/c-vis/c-sel-vis/dwb-zoom-regression-view.md)
      ...
      + Sottoinsieme {#subsets}
         + [Panoramica dei sottoinsiemi](c-get-started/c-vis/c-wk-subsets/c-wk-subsets.md)
      ...
      + [Creazione guidata di dimensioni basate su metriche](c-get-started/c-vis/dwb-create-metricdim/dwb-create-metricdim.md)
      + [Modifica delle dimensioni basate su metriche](c-get-started/c-vis/dwb-create-metricdim/dwb-6-4-metric-dim-edit.md)
   + Visualizzazioni di analisi {#analysis-visualizations}
      ...
      + [Grafici a dispersione 2D](c-get-started/c-analysis-vis/c-scat-plots.md)
      + [Grafici a dispersione 3D](c-get-started/c-analysis-vis/c-3d-scatterplots.md)
      + Annotazioni {#annotations}
         ...
         + [Annotazioni di immagine](c-get-started/c-analysis-vis/c-annots/c-image-annots.md)
         + [Annotazioni titolo dinamiche](c-get-started/c-analysis-vis/c-annots/c-dyn-title-annots.md)
      + [Visualizzazione di associazione a corde](c-get-started/c-analysis-vis/associations-chord.md)
      ...
      + [Visualizzazione a corde](c-get-started/c-analysis-vis/c-chord-visualization.md)
      ...
      + Generatore dell’albero delle decisioni {#decision-trees}
         + [Panoramica di Generatore dell’albero delle decisioni](c-get-started/c-analysis-vis/c-decision-trees/c-decision-trees.md)
      ...
      + Grafici {#graphs}
         ...
         + [Aggiunta e modifica di una metrica](c-get-started/c-analysis-vis/c-graphs/c-add-chg-metrics.md)
      ...
      + Analisi guidata {#guided-analysis}
         ...
         + [Visualizzare il menu Dimensione](c-get-started/c-analysis-vis/c-guided-analysis/t-disp-menu.md)
      ...
      + Legende {#legends}
         ...
         + [Legende delle metriche](c-get-started/c-analysis-vis/c-legends/c-metric-leg.md)
      ...
      + Browser del percorso {#path-browsers}
         ...
         + [Visualizzare le informazioni sulle metriche](c-get-started/c-analysis-vis/c-path-browsers/c-disp-metric-info.md)
         + [Estendere un percorso](c-get-started/c-analysis-vis/c-path-browsers/c-ex-paths.md)
         + [Visualizzare l’inizio e la fine dei percorsi](c-get-started/c-analysis-vis/c-path-browsers/c-disp-starts-.md)
         + [Modificare la directory principale del browser del percorso](c-get-started/c-analysis-vis/c-path-browsers/c-chg-root.md)
      ...
      + Mappa del processo {#process-maps}
         ...
         + [Spostare e ruotare una mappa del processo](c-get-started/c-analysis-vis/c-proc-maps/c-move-proc-maps.md)
         ...
         + [Assegnare un’etichetta a un nodo](c-get-started/c-analysis-vis/c-proc-maps/c-label-nodes.md)
         + [Selezione da una mappa del processo](c-get-started/c-analysis-vis/c-proc-maps/c-sel-proc-maps.md)
         + [Salvare una dimensione da una mappa del processo](c-get-started/c-analysis-vis/c-proc-maps/t-dim-proc-maps.md)
      ...
      + Punteggio propensione {#visitor-propensity}
         + [Panoramica del punteggio della propensione](c-get-started/c-analysis-vis/c-visitor-propensity/c-visitor-propensity.md)
         + [Impostazione del punteggio della propensione](c-get-started/c-analysis-vis/c-visitor-propensity/t-propensity-steps.md)
         + [Calcolo del punteggio della propensione](c-get-started/c-analysis-vis/c-visitor-propensity/c-propensity-confusion-matrix.md)
         + [Grafici di guadagno e incremento della propensione](c-get-started/c-analysis-vis/c-visitor-propensity/c-propensity-gain-lift-chart.md)
      ...
      + Segmenti {#segments}
         + [Panoramica dei segmenti](c-get-started/c-analysis-vis/c-seg/c-seg.md)
         + [Creare dimensioni di segmento](c-get-started/c-analysis-vis/c-seg/c-create-seg-dim.md)
      ...
      + Tabelle {#tables}
         ...
         + [Aggiungere e modificare una metrica](c-get-started/c-analysis-vis/c-tables/c-add-metrics.md)
         + [Aggiungere, modificare e spostare una dimensione](c-get-started/c-analysis-vis/c-tables/c-add-chg-dim.md)
         + [Adattare i dati a una finestra](c-get-started/c-analysis-vis/c-tables/c-fit-data-win.md)
      ...
      + [Utilizzo dei dati nei fogli di lavoro](c-get-started/c-analysis-vis/c-data-wksts.md)
      + Fogli di lavoro {#worksheets}
         + [Panoramica dei fogli di lavoro](c-get-started/c-analysis-vis/c-wksts/c-wksts.md)
   ...
   + Livelli delle immagini {#imagery-layers}
   ...
   + Interfacce amministrative {#admin-ui}
      ...
      + [Interfaccia schema del set di dati](c-get-started/c-admin-intrf/c-dtst-sch-intrf.md)
      + [Legenda stato della query](c-get-started/c-admin-intrf/c-query-stat-lgnd.md)
      + Coda della query {#query-que}
         + [Panoramica della coda della query](c-get-started/c-admin-intrf/c-query-que/c-query-que.md)
         + [Gruppi utenti della coda della query](c-get-started/c-admin-intrf/c-query-que/c-query-que-user-grps.md)
         + [Monitoraggio risorse della coda della query](c-get-started/c-admin-intrf/c-query-que/c-query-que-res-mon.md)
      ...
      + Gestione dei profili {#profile-mgr}
         ...
         + [Utilizzo delle metriche derivate](c-get-started/c-admin-intrf/c-prof-mgr/c-drvd-mtrcs.md)
         + [Utilizzo delle dimensioni derivate](c-get-started/c-admin-intrf/c-prof-mgr/c-dvrd-dim.md)
         + [Blocco dei profili nella workstation](c-get-started/c-admin-intrf/c-prof-mgr/dwb-profile-lock.md)
      + Gestioni dei set di dati {#dataset-mgrs}
         + [Gestioni dei set di dati](c-get-started/c-admin-intrf/c-dataset-mgrs/c-dataset-mgrs.md)
         + Mappe di dipendenza {#dep-maps}
            ...
            + [Visualizzare i dettagli del nodo](c-get-started/c-admin-intrf/c-dataset-mgrs/c-dep-maps/c-view-node-dtls.md)
            ...
            + [Visualizzare i dati sulle prestazioni](c-get-started/c-admin-intrf/c-dataset-mgrs/c-dep-maps/c-disp-perf-data.md)
      ...
      + [Gestore di server](c-get-started/c-admin-intrf/c-svrs-mgr.md)
      + [Opzione desktop remoto](c-get-started/c-admin-intrf/t-rmt-dsktp-opt.md)
      + [Gestore di file dei server](c-get-started/c-admin-intrf/c-svr-files-mgr.md)
      + [Interfaccia del monitor server](c-get-started/c-admin-intrf/c-svr-mtr-intfc.md)
   ...
   + Funzionalità di interfaccia e analisi {#ui-analysis-features}
      ...
      + Personalizzare i menu {#custom-menus}
         ...
         + [Creare un menu e una voce di menu dell’area di lavoro](c-get-started/c-intf-anlys-ftrs/c-ctm-menus/c-wksp-menus-itms.md)
      ...
      + Personalizzare il gestore di profili e il gestore di file dei server {#cstm-prof-files-mgrs}
         + [Personalizzare il gestore di profili e il gestore di file dei server](c-get-started/c-intf-anlys-ftrs/c-cstm-prof-files-mgrs/c-cstm-prof-files-mgrs.md)
         + [Creare un gestore di profili](c-get-started/c-intf-anlys-ftrs/c-cstm-prof-files-mgrs/c-new-prof-mgrs.md)
         + [Creare un gestore di file del server](c-get-started/c-intf-anlys-ftrs/c-cstm-prof-files-mgrs/c-new-svr-files-mgrs.md)
      + Personalizzare una scheda del Worktop {#cstm-wktp-tabs}
         + [Personalizzare una scheda del Worktop](c-get-started/c-intf-anlys-ftrs/c-cstm-wktp-tabs/c-cstm-wktp-tabs.md)
         + [Aggiungere una scheda al Worktop](c-get-started/c-intf-anlys-ftrs/c-cstm-wktp-tabs/t-add-tabs.md)
         + [Modificare l’ordine delle schede](c-get-started/c-intf-anlys-ftrs/c-cstm-wktp-tabs/t-chg-ordr-tabs.md)
      ...
      + Configurare un’area di lavoro bloccata {#config-locked-wkspc}
         ...
         + [Impostare il parametro di sblocco](c-get-started/c-intf-anlys-ftrs/c-config-locked-wkspc/c-unlck-param.md)
      ...
      + [Configurare un browser di percorsi](c-get-started/c-intf-anlys-ftrs/t-config-path-brwsr.md)
      + [Configurare la mappa di un processo](c-get-started/c-intf-anlys-ftrs/t-config-proc-maps.md)
      + [Configurare l’interfaccia dello schema del set di dati](c-get-started/c-intf-anlys-ftrs/t-dataset-schema-intf.md)
   ...
   + Sintassi del linguaggio di query {#qry-lang-syntx}
      ...
      + [Sintassi per le espressioni metriche](c-get-started/c-qry-lang-syntx/c-syntx-mtrc-exp.md)
      + [Sintassi per le espressioni dimensione](c-get-started/c-qry-lang-syntx/c-syntx-dim-exp.md)
      + [Sintassi per le espressioni filtro](c-get-started/c-qry-lang-syntx/c-syntx-fltr-exp.md)
      + [Sintassi per le espressioni matematiche](c-get-started/c-qry-lang-syntx/c-math-expressions.md)
...
+ Configurazione del set di dati {#dataset}
   + [Informazioni sulla costruzione del set di dati](c-dataset-const-proc/c-dataset-constr.md)
   + [Informazioni sulla configurazione dei set di dati](c-dataset-const-proc/c-dataset-config.md)
   + [Supporto di Data Workbench per il GDPR](c-dataset-const-proc/dwb-gdpr.md)
   + File di configurazione per l’elaborazione del registro {#log-proc-config-file}
      + [Informazioni sul file di configurazione dell’elaborazione dei registri](c-dataset-const-proc/c-log-proc-config-file/c-abt-log-proc-config-file.md)
      + [Modifica del file di configurazione dell’elaborazione dei registri](c-dataset-const-proc/c-log-proc-config-file/t-edit-log-proc-config-file.md)
      + [Origini dei registri](c-dataset-const-proc/c-log-proc-config-file/c-log-sources.md)
      + [Configurazione di un’unità server per il file dei server di Data Workbench](c-dataset-const-proc/c-log-proc-config-file/c-ins-svr-file-svr-unit.md)
      + [Parametri di elaborazione dei registri](c-dataset-const-proc/c-log-proc-config-file/c-info-log-proc-param.md)
      + [Origini dati ODBC](c-dataset-const-proc/c-log-proc-config-file/c-odbc-data-sources.md)
      + [Considerazioni per il file di configurazione dell’elaborazione dei registri](c-dataset-const-proc/c-log-proc-config-file/c-cons-log-proc-config-file.md)
   + File di configurazione delle trasformazioni {#trans-config-file}
      ...
      + Parametri di trasformazione specifici {#specific-trans-param}
         ...
         + [Condizione per nuovi visitatori](c-dataset-const-proc/c-trans-config-file/c-spec-trans-param/c-new-vstr-con.md)
   ...
   + File di inclusione nel set di dati {#dataset-include-files}
      + [Informazioni sui file di inclusione nel set di dati](c-dataset-const-proc/c-dataset-inc-files/c-abt-dataset-inc-files.md)
      + [Utilizzo dei file di inclusione nel set di dati](c-dataset-const-proc/c-dataset-inc-files/c-work-dataset-inc-files/c-work-dataset-inc-files.md)
      + [Modifica di file di inclusione nel set di dati esistenti](c-dataset-const-proc/c-dataset-inc-files/c-work-dataset-inc-files/t-edit-ex-dataset-inc-files.md)
      + [Creazione di nuovi file di inclusione nel set di dati](c-dataset-const-proc/c-dataset-inc-files/c-work-dataset-inc-files/t-create-new-dataset-inc-files.md)
      + Tipi di file di inclusione nel set di dati {#types-dataset-inc-files}
         + [Tipi di file di inclusione nel set di dati](c-dataset-const-proc/c-dataset-inc-files/c-types-dataset-inc-files/c-types-dataset-inc-files.md)
         + [Elaborazione del registro di file di inclusione nel set di dati](c-dataset-const-proc/c-dataset-inc-files/c-types-dataset-inc-files/c-log-proc-dataset-inc-files/c-log-proc-dataset-inc-files.md)
         + [Gruppi di decoder di file di testo](c-dataset-const-proc/c-dataset-inc-files/c-types-dataset-inc-files/c-log-proc-dataset-inc-files/c-text-file-dec-groups.md)
         + [Gruppi di decoder XML](c-dataset-const-proc/c-dataset-inc-files/c-types-dataset-inc-files/c-log-proc-dataset-inc-files/c-xml-dec-grps.md)
         + [File di inclusione nel set di dati per trasformazioni](c-dataset-const-proc/c-dataset-inc-files/c-types-dataset-inc-files/c-trans-dataset-inc-files.md)
      + Definizione dei parametri dei file di inclusione nel set di dati {#def-param-dataset-inc-files}
         + [Definizione dei parametri dei file di inclusione nel set di dati](c-dataset-const-proc/c-dataset-inc-files/c-def-param-dataset-inc-files/c-def-param-dataset-inc-files.md)
   ...
   + Trasformazioni dei dati {#data-transformations}
      ...
      + Tipi di trasformazioni {#transform-types}
         ...
         + [Distribuzione di DeviceAtlas](c-inst-svr/c-upgrd-uninst-sftwr/c-upgrd-sftwr/c-6-0-to-6-1-upgrade/c-deviceatlas-update.md)
   ...
   + Dimensioni estese {#extended-dimensions}
      ...
      + Tipi di dimensioni estese {#extended-dimensions-types}
         ...
         + [Dimensioni conteggiabili](c-dataset-const-proc/c-ex-dim/c-types-ex-dim/c-count-dim.md)
         + [Dimensioni semplici](c-dataset-const-proc/c-ex-dim/c-types-ex-dim/c-simple-dim.md)
         + [Dimensioni da molte a molte](c-dataset-const-proc/c-ex-dim/c-types-ex-dim/c-many-dim.md)
         + [Dimensioni numeriche](c-dataset-const-proc/c-ex-dim/c-types-ex-dim/c-num-dim.md)
         + [Dimensioni denomalizzate](c-dataset-const-proc/c-ex-dim/c-types-ex-dim/c-denormal-dim.md)
   ...
   + Funzionalità di trasformazione {#transform-functionality}
      ...
      + File di configurazione per la trasformazione {#config-files-transform}
         ...
         + [Il file Transform Mode.cfg](c-dataset-const-proc/c-transf-func/c-config-files-transf/t-transf-mode-file.md)
         + [Il file Required Field Definitions.cfg](c-dataset-const-proc/c-transf-func/c-config-files-transf/c-req-field-def-file.md)
   + Rielaborazione e riconversione {#reproc-retrans}
      ...
      + [Preparazione alla rielaborazione o riconversione](c-dataset-const-proc/c-reproc-retrans/t-prep-reproc-retrans.md)
   + Strumenti di configurazione dei set di dati {#dataset-config-tools}
      + [Strumenti di configurazione dei set di dati](c-dataset-const-proc/c-dataset-config-tools/c-dataset-config-tools.md)
      + Interfacce di configurazione dei set di dati {#dataset-config-ui}
         + [Utilizzo delle Interfacce di configurazione dei set di dati](c-dataset-const-proc/c-dataset-config-tools/c-dataset-config-int/c-dataset-config-int.md)
         + [Schema dei set di dati](c-dataset-const-proc/c-dataset-config-tools/c-dataset-config-int/c-dataset-schema.md)
      ...
      + Nascondere i componenti del set di dati {#hide-dataset-comp}
         ...
         + [Nascondere i file di configurazione dei set di dati](c-dataset-const-proc/c-dataset-config-tools/c-hide-dataset-comp/t-hide-dataset-config-files.md)
   + Condizioni {#conditions}
      ...
      + Operazioni di test {#test-ops}
         ...
         + [Condizioni per le operazioni di test](c-dataset-const-proc/c-conditions/c-test-ops/c-test-op-con.md)
   ...
   + [Campi record di dati evento](c-dataset-const-proc/c-ev-data-rec-fields.md)
   + Impostazioni di configurazione per i dati web {#config-web-data}
      ...
      + [Impostazioni specifiche per il web per l’elaborazione dei registri](c-dataset-const-proc/c-config-web-data/c-web-spec-log-proc.md)
...
+ Server dei rapporti {#report-server}
   + [Informazioni sui set di rapporti](c-rpt-oview/c-underst-rpt-sets.md)
   + [Generazione di rapporti](c-rpt-oview/c-gen-rpts.md)
   + [Distribuzione di rapporti](c-rpt-oview/c-distrib-rpts.md)
   + [Requisiti dei set di rapporti](c-rpt-oview/c-rpt-set-req.md)
   + Utilizzo dei set di rapporti {#report-sets}
      ...
      + Creazione di un set di rapporti {#create-report-set}
         ...
         + [Creare le aree di lavoro del server di rapporti](c-rpt-oview/c-work-rpt-sets/t-create-rpt-set/t-create-rpt-wrksp.md)
      + Configurare il set di rapporti {#config-report-set}
         + [Configurare il set di rapporti](c-rpt-oview/c-work-rpt-sets/t-create-rpt-set/t-config-rpt-set/t-config-rpt-set.md)
   ...
   + Portale dei rapporti {#report-portal}
      + [Utilizzo del portale dei rapporti](c-rpt-oview/c-rpt-portal/c-rpt-portal.md)
      + [Apertura del portale dei rapporti](c-rpt-oview/c-rpt-portal/t-open-rpt-port.md)
   + [Ricerca avanzata nel portale dei rapporti](c-rpt-oview/c-search-adv.md)
   + Installazione del server dei rapporti {#install-report-server}
      + [Installazione del server dei rapporti](c-rpt-oview/c-inst-rpt/c-inst-rpt.md)
      ...
      + [Installazione dei file del programma dei rapporti](c-rpt-oview/c-inst-rpt/t-install-rpt-prg-files.md)
      ...
      + [Aggiornare il server dei rapporti con un file della lingua (file .zbin)](c-rpt-oview/c-inst-rpt/c-zbin-file-update.md)
      + [Abilitazione dell’accesso al server di Data Workbench](c-rpt-oview/c-inst-rpt/t-en-acc-ins-svr.md)
      + [Visualizzazione dello stato del server dei rapporti](c-rpt-oview/c-inst-rpt/t-display-svr-st-rpt.md)
      + [Registrazione del server dei rapporti come servizio Windows](c-rpt-oview/c-inst-rpt/t-reg-rpt-win-svc.md)
      + [Aggiornamento e disinstallazione del server di rapporto](c-rpt-oview/c-inst-rpt/c-upgrade-uninstall-rpt.md)
   + Amministrazione del server dei rapporti {#admin-report-server}
      + [Amministrazione del server dei rapporti](c-rpt-oview/c-admin-rpt/c-admin-rpt.md)
      ...
      + [Conferma dell’esecuzione del server dei rapporti](c-rpt-oview/c-admin-rpt/c-rpt-svc-run.md)
      + [Monitoraggio dello spazio su disco](c-rpt-oview/c-admin-rpt/c-mon-disk-sp.md)
      + [Riavvio del server dei rapporti](c-rpt-oview/c-admin-rpt/t-restart-rpt.md)
   ...
   + Installazione del portale dei rapporti {#install-report-portal}
      + [Installazione del portale dei rapporti](c-rpt-oview/c-install-rpt-port/c-install-rpt-port.md)
      + [Installare i file dell’applicazione del portale dei rapporti](c-rpt-oview/c-install-rpt-port/t-install-rpt-portal-app.md)
      + Mappatura delle pagine del portale dei rapporti {#mapping-report-portal-pages}
         + [Mappatura delle pagine del portale dei rapporti su directory virtuali](c-rpt-oview/c-install-rpt-port/c-virtual-dir/c-virtual-dir.md)
         + [Mappatura del portale dei rapporti su una directory virtuale (IIS 7.0 o versione successiva)](c-rpt-oview/c-install-rpt-port/c-virtual-dir/c-map-rpt-port-vdir-7.md)
         + [Mappatura del portale dei rapporti su una directory virtuale (IIS 6.0)](c-rpt-oview/c-install-rpt-port/c-virtual-dir/c-map-rpt-port-vdir-6.md)
         + [Mappatura del ortale dei rapporti su una directory virtuale (IIS 5.0)](c-rpt-oview/c-install-rpt-port/c-virtual-dir/c-map-rpt-port-vdir-5.md)
      ...
      + [Personalizzare l’interfaccia utente del portale dei rapporti](c-rpt-oview/c-install-rpt-port/c-rpt-port-user-inter.md)
      + [Impostare le autorizzazioni per il database](c-rpt-oview/c-install-rpt-port/t-set-data-perm.md)
      + [Test del portale dei rapporti](c-rpt-oview/c-install-rpt-port/t-test-rpt-port.md)
      + [Definire account aggiuntivi](c-rpt-oview/c-install-rpt-port/c-def-addl-accts.md)
   + Documentazione sui parametri del server dei rapporti {#report-server-parameters}
      + [Parametri di Report Server.cfg](c-rpt-oview/c-rpt-param-ref/c-rpt-svr-param.md)
      + [Parametri di Report.cfg](c-rpt-oview/c-rpt-param-ref/c-rpt-param.md)
   + File di esempio dei rapporti {#report-sample-files}
      + [File di esempio dei rapporti](c-rpt-oview/c-rpt-sample-files/c-rpt-sample-files.md)
      + [Esempio di Indice dei rapporti](c-rpt-oview/c-rpt-sample-files/c-sample-rpt-ind.md)
      + [Esempio di foglio di stile XSL](c-rpt-oview/c-rpt-sample-files/c-sample-xsl-st-sheet.md)
      + [Esempio di foglio di stile XSL per e-mail](c-rpt-oview/c-rpt-sample-files/c-sample-mail-style-sheet.md)
+ Assegnazione di tag alle pagine {#page-tagging}
   + [Che tipo di dati posso acquisire?](c-undst-pg-tag/c-acq-data.md)
   + [Come posso acquisire questi dati_](c-undst-pg-tag/t-how-acq-data-.md)
   + Implementazione dei tag di pagina di riferimento {#implement-ref-page-tags}
      + [Implementazione dei tag di pagina di riferimento](c-undst-pg-tag/c-imp-ref-pg-tags/c-imp-ref-pg-tags.md)
      + [Modifica dello script di esecuzione dei tag di pagina di riferimento](c-undst-pg-tag/c-imp-ref-pg-tags/t-edit-ref-pg-tag-ex-scrpt.md)
      + [Aggiunta di chiamate di esecuzione dei tag di pagina di riferimento](c-undst-pg-tag/c-imp-ref-pg-tags/c-ref-pg-tag-ex-calls.md)
      + [Informazioni sul cookie v1st](c-undst-pg-tag/c-imp-ref-pg-tags/c-undst-v1st-ck.md)
   + Acquisizione delle misurazioni baseline {#acquire-base-measures}
      + [Panoramica sull’acquisizione delle misurazioni baseline](c-undst-pg-tag/c-acq-bsln-msmts/c-acq-bsln-msmts.md)
      + Acquisizione dei dati della richiesta di pagina {#acquire-page-request}
         + [Panoramica dell’acquisizione dei dati della richiesta di pagina](c-undst-pg-tag/c-acq-bsln-msmts/c-acq-pg-req-data/c-acq-pg-req-data.md)
   ...
   + Acquisizione di misurazioni estese {#acquire-ext-measures}
      + [Acquisizione di misurazioni estese](c-undst-pg-tag/c-acq-ext-msmt/c-acq-ext-msmt.md)
      ...
      + [Misurazione delle impression di annunci](c-undst-pg-tag/c-acq-ext-msmt/c-msr-adv-imp.md)
      + [Tracciamento dei clic sui collegamenti](c-undst-pg-tag/c-acq-ext-msmt/c-trk-lnk-clicks.md)
      + [Tracciamento delle uscite verso collegamenti esterni](c-undst-pg-tag/c-acq-ext-msmt/c-trk-ex-ext-links.md)
      + Acquisizione dell’input nei campi modulo {#form-field-inpu}
         + [Acquisizione dell’input nei campi modulo](c-undst-pg-tag/c-acq-ext-msmt/c-acq-frm-fld-inpt/c-acq-frm-fld-inpt.md)
         + [Informazioni generali](c-undst-pg-tag/c-acq-ext-msmt/c-acq-frm-fld-inpt/c-gen-info.md)
         + [Informazioni specifiche su ASP](c-undst-pg-tag/c-acq-ext-msmt/c-acq-frm-fld-inpt/c-asp.md)
   + [Tracciamento delle attività dei visitatori all’interno di contenuti rich media Flash](c-undst-pg-tag/t-trk-vstr-act.md)
   + [Considerazioni P3P per tag di pagina di terze parti](c-undst-pg-tag/c-cons-thrd-pty-pg-tag.md)
   + [Foglio di lavoro per la mappatura delle variabili del tag di pagina](c-undst-pg-tag/c-pg-tag-wkst.md)
+ Metriche, dimensioni e filtri {#metrics}
   ...
   + [Creazione guidata di dimensioni basate su metriche](c-about/metric-dim.md)
   ...
   + Profili baseline {#baseline-profiles}
      + [Panoramica dei profili baseline](c-about/c-about-baseline-profiles/c-about-baseline-profiles.md)
      + [Metriche del profilo Traffico](c-about/c-about-baseline-profiles/c-traffic-profile.md)
      + [Dimensioni del profilo Traffico](c-about/c-about-baseline-profiles/c-traffic-profile-dims.md)
      + [Metriche del profilo Valore](c-about/c-about-baseline-profiles/c-value-profile-metrics.md)
      + [Dimensioni del profilo Valore](c-about/c-about-baseline-profiles/c-value-profile-dims.md)
      + [Dimensioni del profilo Marketing](c-about/c-about-baseline-profiles/c-marketing-profile.md)
+ Geografia {#geography}
   ...
   + Livelli delle immagini {#imagery-layers}
      + [Informazioni sui livelli immagini](c-geo-oview/c-wk-img-lyrs/c-undst-img-lyrs.md)
      + Livelli immagine del terreno {#terrain-image-layers}
         + [Utilizzo dei livelli immagine del terreno](c-geo-oview/c-wk-img-lyrs/c-trn-img-lyrs/c-trn-img-lyrs.md)
         + [Specificare le informazioni di proiezione per le immagini del terreno](c-geo-oview/c-wk-img-lyrs/c-trn-img-lyrs/c-proj-info-trn-imgs/c-proj-info-trn-imgs.md)
         + [Proiezioni di latitudine e longitudine](c-geo-oview/c-wk-img-lyrs/c-trn-img-lyrs/c-proj-info-trn-imgs/c-lat-long-proj.md)
         + [Proiezioni universali di Transverse Marcator](c-geo-oview/c-wk-img-lyrs/c-trn-img-lyrs/c-proj-info-trn-imgs/c-utm-proj.md)
         + [Rendere disponibile un nuovo livello immagine del terreno](c-geo-oview/c-wk-img-lyrs/c-trn-img-lyrs/t-new-trn-img-lyr.md)
      + Livelli del punto elemento {#element-point-layers}
         ...
         + [Rendere disponibile un nuovo livello del punto elemento](c-geo-oview/c-wk-img-lyrs/c-elmt-pt-lyrs/t-new-elmt-pt-lyr-avail.md)
   ...
   + Aggiornamento e disinstallazione della geografia di Data Workbench {#upgrade-uninstall-geo}
      + [Aggiornamento della geografia di Data Workbench](c-geo-oview/c-upgrd-uninst-geo/t-upgrd-geo.md)
...
+ Esperimenti controllati {#experiments}
   + [Informazioni sugli esperimenti controllati di Data Workbench](c-undst-ctrld-exp/c-undst-ctrld-exp.md)
...
+ Amministrazione e installazione del server {#server-admin-install}
   ...
   + Amministrazione del server di Data Workbench {#admin-dwb-server}
      ...
      + [Monitoraggio dei registri di controllo](c-inst-svr/c-admin-inst-svr/t-mntr-adt-lgs.md)
   ...
   + Ripetitore {#repeater}
      + [Funzionalità del ripetitore](c-inst-svr/c-rptr-fntly/c-rptr-fntly.md)
      + Configurazione di {#configure}
         + [Configurazione della funzionalità del ripetitore](c-inst-svr/c-rptr-fntly/c-cnfg-rptr-fntly/c-cnfg-rptr-fntly.md)
         + [Configurazione di un FSU di Insight Server per il ripetitore](c-inst-svr/c-rptr-fntly/c-cnfg-rptr-fntly/t-cfg-fsu-rptr.md)
         ...
         + [Creazione di una connessione tra Insight e il ripetitore](c-inst-svr/c-rptr-fntly/c-cnfg-rptr-fntly/t-crt-conn-ins-rptr.md)
         + [Passaggi successivi](c-inst-svr/c-rptr-fntly/c-cnfg-rptr-fntly/c-nxt-stps-reptr.md)
      + [Amministrazione del ripetitore](c-inst-svr/c-rptr-fntly/c-admin-rptr.md)
   + Amministrazione generale dei sistemi {#general-syst-admin}
      ...
      + [Monitoraggio degli eventi per gli errori](c-inst-svr/c-gen-syst-admin/c-mntr-errs.md)
   ...
   + Aggiornamento e disinstallazione {#upgrade-uninstall}
      ...
      + Aggiornamento di Insight Server {#upgrade-insight-server}
         ...
         + [Aggiornamento del ripetitore](c-inst-svr/c-upgrd-uninst-sftwr/c-upgrd-sftwr/c-upgrd-rptr.md)
   ...
   + Impostazioni di configurazione {#config-settings}
      ...
      + [Struttura della directory di Insight Server](c-inst-svr/c-cfg-stgs-ref/c-ins-svr-dir-str.md)
...
+ Sensore {#sensor}
   ...
   + [Quali sono i componenti di base](c-snsr-ovrvw/c-basic-comp.md)
   ...
   + Amministrazione {#admin-sensor}
      ...
      + [Conferma dell’esecuzione del trasmettitore dati](c-snsr-ovrvw/admin-sensor/c-data-trmtr-rng.md)
      + [Monitoraggio degli eventi amministrativi](c-snsr-ovrvw/admin-sensor/c-mntr-admin-evts.md)
      + [Modifica del server di destinazione di Data Workbench](c-snsr-ovrvw/admin-sensor/t-trgt-ins-svr.md)
   ...
   + Campi record di dati evento {#event-data-record}
      + [Campi record di dati evento](c-snsr-ovrvw/c-evnt-data-rcd-flds/c-evnt-data-rcd-flds.md)
      + [Campi record di dati evento baseline ](c-snsr-ovrvw/c-evnt-data-rcd-flds/c-bsln-evnt-data.md)
   ...
   + File di configurazione di esempio {#sample-configs}
      ...
      + [Esempi del file Txlogd.conf](c-snsr-ovrvw/sensor-sample-configs/txlogd-conf-samples.md)
   + [Opzioni riga di comando per Sensor Transmitter](c-snsr-ovrvw/sensor-transmitter-options.md)
...
+ Installazione del profilo di monitoraggio {#monitor}
   ...
   + Aree di lavoro {#workspace}
      ...
      + [Area di lavoro per la cronologia di Data Workbench](monitoring-installation/monitoring-profiles/monitoring-historical-using.md)
      + [Area di lavoro per lo stato del profilo di Data Workbench](monitoring-installation/monitoring-profiles/monitoring-profile-using.md)
      + [Area di lavoro per lo stato del server di Data Workbench](monitoring-installation/monitoring-profiles/monitoring-server-using.md)
   + Dimensioni e metriche del profilo di Data Workbench {#monitoring-appendix}
      ...
      + [Metriche nel profilo di monitoraggio di cronologia di Data Workbench](monitoring-installation/monitoring-appendix/monitoring-hist-metrics.md)
+ Dashboard {#dashboard}
   + [Opportunità di business](c-adobe-data-workbench-dashboard/c-business-opportunities.md)
   ...
   + [Interfaccia utente della dashboard](c-adobe-data-workbench-dashboard/t-getting-started/c-dashboard-user-interface.md)
   + Visualizzazioni {#visualizations}
      ...
      + Tipi di visualizzazione {#visualization-types}
         ...
         + [Legende delle metriche](c-adobe-data-workbench-dashboard/c-visualizations/c-visualization-types/c-metric-legends.md)
         + [Grafico a torta](c-adobe-data-workbench-dashboard/c-visualizations/c-visualization-types/c-dashboard-pie-chart.md)
         + [Grafico a dispersione](c-adobe-data-workbench-dashboard/c-visualizations/c-visualization-types/c-scatter-plot.md)
         + [Rich text](c-adobe-data-workbench-dashboard/c-visualizations/c-visualization-types/c-rich-text.md)
      + [Creazione delle visualizzazioni](c-adobe-data-workbench-dashboard/c-visualizations/t-creating-visualizations.md)
      ...
      + Manipolazione delle visualizzazioni {#manipulating-visualizations}
         ...
         + [Rimozione delle visualizzazioni](c-adobe-data-workbench-dashboard/c-visualizations/c-manipulating-visualizations/c-remove-visualizations.md)
   ...
   + Dashboard {#dashboards}
      ...
      + Visualizzazione delle dashboard {#viewing-dashboards}
         + [Apertura e visualizzazione delle dashboard](c-adobe-data-workbench-dashboard/c-dashboards/c-opening-and-viewing-dashboards/c-opening-and-viewing-dashboards.md)
         ...
         + Browser delle dashboard {#dashboard-browser}
            + [Browser delle dashboard](c-adobe-data-workbench-dashboard/c-dashboards/c-opening-and-viewing-dashboards/c-dashboard-browser/c-dashboard-browser.md)
            + [Viste del browser delle dashboard](c-adobe-data-workbench-dashboard/c-dashboards/c-opening-and-viewing-dashboards/c-dashboard-browser/c-dashboard-browser-views.md)
            + [Ricerca nel browser delle dashboard](c-adobe-data-workbench-dashboard/c-dashboards/c-opening-and-viewing-dashboards/c-dashboard-browser/c-searching-within-the-dashboard-browser.md)
         + [Collegamento ipertestuale delle dashboard](c-adobe-data-workbench-dashboard/c-dashboards/c-opening-and-viewing-dashboards/c-dashboard-hyperling.md)
      + [Parametro Query-To](c-adobe-data-workbench-dashboard/c-dashboards/c-query-to-parameter.md)
      + [Creazione di una dashboard](c-adobe-data-workbench-dashboard/c-dashboards/c-creating-a-dashboard.md)
      + [Salvataggio di una dashboard](c-adobe-data-workbench-dashboard/c-dashboards/t-saving-a-dashboard.md)
      + [Modifica o aggiornamento di una dashboard](c-adobe-data-workbench-dashboard/c-dashboards/t-editing-updating-a-dashboard.md)
      + [Copia di una dashboard](c-adobe-data-workbench-dashboard/c-dashboards/t-making-a-copy-of-a-dashboard.md)
      + [Altre funzioni per le dashboard](c-adobe-data-workbench-dashboard/c-dashboards/c-other-dashboard-functions.md)
      + [Controlli per condividere e accedere alle dashboard](c-adobe-data-workbench-dashboard/c-dashboards/c-dashboard-sharing-and-access-controls.md)
   + Selezione {#select}
      + [Effettuare selezioni nella dashboard](c-adobe-data-workbench-dashboard/c-making-selections-within-the-dashboard/c-making-selections-within-the-dashboard.md)
      ...
      + [Rimozione delle selezioni](c-adobe-data-workbench-dashboard/c-making-selections-within-the-dashboard/c-removing-selections.md)
      ...
      + [Selezioni tra profili diversi](c-adobe-data-workbench-dashboard/c-making-selections-within-the-dashboard/c-cross-profile-selections.md)
   + [Esportazione dei dati](c-adobe-data-workbench-dashboard/c-exporting-data.md)
   + [Controlli di accesso alle dashboard](c-adobe-data-workbench-dashboard/c-dashboard-access-controls.md)
   + [Gestione dell’account utente](c-adobe-data-workbench-dashboard/c-user-account-functions.md)
   + [Menu Aiuto](c-adobe-data-workbench-dashboard/c-help-menu.md)
+ Amministratore delle dashboard {#admin}
   ...
   + Comunicazione con il server {#servers-communication}
      ...
      + [Verifica dell’abilitazione di Query API](c-preparing-for-dashboard-installation/c-dashboard-to-data-workbench-servers-communication/t-verifying-qurey-api-enablement.md)
      + [Configurazione del controllo dell’accesso alle dashboard](c-preparing-for-dashboard-installation/c-dashboard-to-data-workbench-servers-communication/t-configuring-access-control.md)
   + Distribuzione delle dashboard {#dashboard-deployment}
      + [Distribuzione delle dashboard](c-preparing-for-dashboard-installation/c-dashboard-deployment/c-dashboard-deployment.md)
      + [Distribuzione della dashboard](c-preparing-for-dashboard-installation/c-dashboard-deployment/t-deploying-the-dashboard.md)
      ...
      + [Inizializzazione della dashboard](c-preparing-for-dashboard-installation/c-dashboard-deployment/t-initializing-the-dashboard.md)
      + [Aggiungere le chiave di licenza della dashboard](c-preparing-for-dashboard-installation/c-dashboard-deployment/t-add-dashboard-license-key.md)
   + [Gestione da console di amministrazione](c-preparing-for-dashboard-installation/c-managing-from-the-administration-console.md)
...
+ Implementare Data Workbench {#implement}
   ...
   + [Istruzioni di onboarding di base per DWB Managed Services](dwb-implement-overview/dwb-implement-provision/dwb-implement-onboarding.md)
   + [Architettura di Data Workbench](dwb-implement-overview/dwb-implement-architecture/dwb-implement-architecture.md)
   + [Strutture conteggiabili per la progettazione dello schema](dwb-implement-overview/dwb-implement-architecture/dwb-implement-arch-countable.md)
   ...
   + Configurazione e implementazione {#implement-configure}
      ...
      + [Impostazione delle dimensioni](dwb-implement-overview/dwb-implement-configure/dwb-implement-dim-setup.md)
      ...
      + [Script per lo strumento di pulitura SAINT](dwb-implement-overview/dwb-implement-configure/dwb-implement-saint-scripting.md)
      + [Governance del trasferimento dei file](dwb-implement-overview/dwb-implement-configure/dwb-implement-file-transfer.md)
      + [Impostazione di Query API](dwb-implement-overview/dwb-implement-configure/dwb-implement-query-api.md)
      + [Elaborazione dei dati - Creazione della chiave primaria](dwb-implement-overview/dwb-implement-configure/dwb-implement-primary-key.md)
...
+ [Pagina di test nascosta](hidden-test-page.md)
